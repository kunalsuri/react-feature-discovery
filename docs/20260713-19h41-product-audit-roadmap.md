...
4. **[S] Get CI green** and confirmed on a fresh push — this has never happened once in this repo's history, so it needs to be explicitly verified, not assumed. ⏳ Pending — will verify after this commit is pushed (see PR #6).
